...
export type EntitlementStatus = "inactive" | "active" | "past_due" | "cancelled" | "quota_exhausted";
...
export type DevicePollResponse = DevicePollPendingResponse | DevicePollApprovedResponse | DevicePollDeniedResponse;
...
export type CloudIntent = "quick_chat" | "summarize" | "rag_answer" | "artifact_plan" | "deep_reasoning" | "vision" | "cheap_background";
...
export type CloudToolChoice = "none" | "auto" | "required" | {
    type: "function";
    function: {
        name: string;
    };
